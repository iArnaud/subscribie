...
test.describe("order plan with free-trial:", () => {
    test("@475@subscriber@Ordering plan with free-trial feature", async ({ page }) => {
        ...
        expect(await page.screenshot()).toMatchSnapshot('free-trial-new-customer-form.png');
        ...
        expect(await page.screenshot()).toMatchSnapshot('free-trial-stripe-checkout-filled.png');
        ...
        expect(await page.screenshot()).toMatchSnapshot('free-trial-order-complete.png');
        ...
        expect(await page.screenshot()).toMatchSnapshot('free-trial-view-subscribers.png');
        ...
        expect(await page.screenshot()).toMatchSnapshot('free-trial-trialing-subscribers.png');
